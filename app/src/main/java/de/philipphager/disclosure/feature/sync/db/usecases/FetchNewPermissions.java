...
/***
 * Fetch all permissions declared by an app, that are not already saved in the
 * database. Because all system permissions are saved in the db, this will
 * normally return custom permissions, that are defined by the apps themselves.
 */
