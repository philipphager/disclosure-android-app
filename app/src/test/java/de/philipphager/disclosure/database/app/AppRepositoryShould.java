...
public class AppRepositoryShould {
  ...
  public void insertAppIntoDatabase() {
    ...
    verify(insertApp)
        .bind(app.label(), app.packageName(), app.process(), app.sourceDir(), app.flags(), app.isTrusted());
  ...
  public void updateAppInDatabase() {
    ...
    verify(updateApp)
        .bind(app.label(), app.process(), app.sourceDir(), app.flags(), app.isTrusted(), app.packageName());
